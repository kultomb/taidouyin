document.addEventListener('DOMContentLoaded', () => {
    ...
    const voices = {
        ...
        gemini: [
            ...
            // --- Nữ (Female) ---
            { value: "Zephyr", label: "🌟 Zephyr - Nữ (Tươi sáng, năng động, trẻ trung)" },
            { value: "Achernar", label: "🌟 Achernar - Nữ (Nhẹ nhàng, mềm mại, êm dịu)" },
            { value: "Aoede", label: "🌟 Aoede - Nữ (Phóng khoáng, tự nhiên, dễ chịu)" },
            { value: "Algieba", label: "🌟 Algieba - Nữ (Mượt mà, sáng sủa)" },
            { value: "Autonoe", label: "🌟 Autonoe - Nữ (Sắc sảo, rõ chữ, chuyên nghiệp)" },
            { value: "Despina", label: "🌟 Despina - Nữ (Trong trẻo, mượt mà)" },
            { value: "Callirrhoe", label: "🌟 Callirrhoe - Nữ (Gần gũi, dễ mến, tự nhiên)" },
            { value: "Erinome", label: "🌟 Erinome - Nữ (Rõ ràng, dứt khoát, dễ nghe)" },
            { value: "Gacrux", label: "🌟 Gacrux - Nữ (Trưởng thành, chững chạc)" },
            { value: "Kore", label: "🌟 Kore - Nữ (Điềm tĩnh, dứt khoát)" },
            { value: "Leda", label: "🌟 Leda - Nữ (Trẻ trung, năng nổ, tốc độ nhanh)" },
            { value: "Laomedeia", label: "🌟 Laomedeia - Nữ (Ấm áp, truyền cảm)" },
            { value: "Pulcherrima", label: "🌟 Pulcherrima - Nữ (Sang trọng, thanh lịch)" },
            { value: "Sulafat", label: "🌟 Sulafat - Nữ (Mộc mạc, tự nhiên)" },
            { value: "Vindemiatrix", label: "🌟 Vindemiatrix - Nữ (Chững chạc, thuyết phục)" },
            // --- Nam (Male) ---
            { value: "Charon", label: "🌟 Charon - Nam (Trầm ấm, rành mạch, chuẩn)" },
            { value: "Enceladus", label: "🌟 Enceladus - Nam (Khàn nhẹ, có hơi thở, truyền cảm)" },
            { value: "Fenrir", label: "🌟 Fenrir - Nam (Sôi nổi, hào hứng, nhiều năng lượng)" },
            { value: "Puck", label: "🌟 Puck - Nam (Vui vẻ, dí dỏm, giải trí cao)" },
            { value: "Achird", label: "🌟 Achird - Nam (Thân thiện, gần gũi, dễ mến)" },
            { value: "Algenib", label: "🌟 Algenib - Nam (Khàn, gai góc, nam tính)" },
            { value: "Alnilam", label: "🌟 Alnilam - Nam (Mạnh mẽ, dứt khoát)" },
            { value: "Orus", label: "🌟 Orus - Nam (Đĩnh đạc, quyền lực, nghiêm túc)" },
            { value: "Iapetus", label: "🌟 Iapetus - Nam (Trong trẻo, rõ chữ, dễ nghe)" },
            { value: "Rasalgethi", label: "🌟 Rasalgethi - Nam (Trầm sâu, điềm đạm)" },
            { value: "Schedar", label: "🌟 Schedar - Nam (Hiện đại, công nghệ)" },
            { value: "Sadachbia", label: "🌟 Sadachbia - Nam (Tự nhiên, uyển chuyển)" },
            { value: "Sadaltager", label: "🌟 Sadaltager - Nam (Ấm áp, trung tính)" },
            { value: "Umbriel", label: "🌟 Umbriel - Nam (Trung tính, đa dụng)" },
            { value: "Zubenelgenubi", label: "🌟 Zubenelgenubi - Nam (Trầm đặc, dày tiếng, nam tính)" }
        ]
    };
